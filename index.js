...
/*async function output(){
    ...
    console.log(await user.username(user));
    console.log(await user.status(user));
    console.log(await user.goals(user));
    console.log(await user.intrests(user));
    console.log(await user.website(user));
    console.log(await user.school(user));
    console.log(await user.location(user));
    console.log(await user.occupation(user));
    console.log(await user.userID(user));
    console.log(await user.posts(user));
    console.log(await thread.author(thread));
    console.log(await thread.postNum(thread));
    console.log(await thread.title(thread));
