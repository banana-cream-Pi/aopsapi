...
async function website(user){
    ...
    await page.waitForSelector('#community-all > div > div:nth-child(2) > div.cmty-user-profile-main.cmty-index-card > div.cmty-user-profile-data > div.cmty-user-profile-main-info > div:nth-child(5) > div:nth-child(2) > a').catch(err =>{if(err){throw new Error('invalid user');}});;
