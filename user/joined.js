...
async function joined(user){
    ...
    await page.waitForSelector('#community-all > div > div:nth-child(2) > div.cmty-user-profile-main.cmty-index-card > div.cmty-user-profile-data > div.cmty-user-profile-main-info > div:nth-child(1) > div:nth-child(2)').catch(err =>{if(err){throw new Error('User has not set this value or invalid user');}});
